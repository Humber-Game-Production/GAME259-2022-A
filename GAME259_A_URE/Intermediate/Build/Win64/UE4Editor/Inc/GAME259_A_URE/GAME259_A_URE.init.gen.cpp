	...
	UPackage* Z_Construct_UPackage__Script_GAME259_A_URE()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_GAME259_A_URE_MessageDamage__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_GAME259_A_URE_MessageStatus__DelegateSignature,
			};
